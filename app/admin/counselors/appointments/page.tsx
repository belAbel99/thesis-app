...
import { Search, RefreshCw, ChevronDown, ChevronUp, Calendar, CheckCircle } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
const CounselorAppointmentsPage = () => {
  ...
  useEffect(() => {
    if (highlightedAppointment && !hasScrolled) {
      setTimeout(() => {
        const element = document.getElementById(`appointment-${highlightedAppointment}`);
        if (element) {
  ...
  }, [highlightedAppointment, hasScrolled, appointments]);
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-gray-600 mt-2">View and manage appointments for {counselorProgram}</p>
            </div>
            <Button 
